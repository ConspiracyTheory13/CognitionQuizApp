...
$(document).ready(function() {
     ...
     let questionForm ='<form role="questionandanswers">' +
               '<h1></h1>' +
               '<input type="radio" name="answer" value="" checked> Call answer<br>' +
               '<input type="radio" name="answer" value=""> Call answer<br>' +
               '<input type="radio" name="answer" value=""> Call answer<br>' +
               '<input type="radio" name="answer" value=""> Call answer<br>' +
               '</form>' +
...
//render the modal
     ...
     const STORE = [
          ...
          },
          {
               ...
               correctAnswer: 'Anchoring Heuristic',
          },
          {
               ...
               correctAnswer: 'Fluency Heuristic',
          },
          {
               ...
               correctAnswer: 'Base rate fallacy',
          },
          {
               ...
               correctAnswer: 'Simulation heuristic',
          },
          {
